...
1. **Tests pass:** `npm test` → 303/303 green.
...
4. **FR10 exit codes:** `node dist/cli/main.js --help` (0), `--version` (0), `bogus` (5), `--nope` (3), `scan /no/such/path` (4).
...
- [ ] `npm test` exits 0 with 303/303 (or more) tests passing.
